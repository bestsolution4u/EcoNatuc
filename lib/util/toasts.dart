  ...
  static Widget _getToastWidget(String msg, ToastType type) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(type == ToastType.SUCCESS ? Icons.check : type == ToastType.ERROR ? Icons.error_outline : Icons.info, color: type == ToastType.ERROR ? Colors.red : Colors.green),
          SizedBox(
            width: 12.0,
          ),
          Text(msg, style: TextStyle(color: type == ToastType.ERROR ? Colors.red : Colors.green)),
        ],
      ),
    );
  }
